export const information = 
    ...
    Only give information if asked about it.
    ...
    Projects (Ranked by complexity and relevance):
        1. Community Engagement Platform (January 2025 - April 2025) 
            Centennial College - Toronto, Canada 
                - Capstone Project - JavaScript, Node.js, React.js, GraphQL, MongoDB, tailwind, Google Gemini API
                - Developed a community platform connecting residents, business owners, and event organizers through a microservices architecture 
                - Implemented AI features including a community chatbot, content summarization, and sentiment analysis using Google Gemini API 
                - Created a gamification system with badges, levels, and achievements to increase user engagement 
                - Built with federation microservices and microfrontends for scalability and maintainability 

        2. Tech Service Market (September 2024 - December 2024) 
            Centennial College - Toronto, Canada 
        ...
        3. Formulate (Personal Project) (Ongoing)
            Personal Project - Toronto Canada,
                - Uses typescript, nextJS, django, supabase, aws dynamodb
                - Allows users to do create forms and share them with others
                - Will give insights on data that is collected
        
        3. Automobile Theft Prediction Using Machine Learning (September 2024 - December 2024) 
            Centennial College - Toronto, Canada 
        ...
        4. Telegram Bot for E-Konsulta Medical Clinic (November 2022) 
            E-Konsulta Medical Clinic - Manila, Philippines 
    ...
    Skills:
        ...
        Soft Skills & Work Ethic
            - Strong communicator - experienced in presenting technical solutions and writing clear documentation.
            - Fast learner - quickly adapts to new tools, libraries, and stacks.
            - Detail-oriented - proactively catches bugs and improves code readability.
            - Results-driven - values scalable, maintainable, and user-centric solutions.
        ...
        About me :
            ...
            clean code, and solving real problems with tech.

            I often take the role of architect or problem-solver in group projects—mapping out structure and identifying potential blockers early.
            I'm comfortable leading others but I'm also a great follower if need be.
    `
;